...
namespace Assets.Scripts.Effects
{
    public class EffectManager : ScriptableObject
    {
        ...
        {
            if (_baseMaterial == null) _baseMaterial = character.Body.sharedMaterial;
        ...
        {
			character.Body.material = _blinkMaterial;

            yield return new WaitForSeconds(0.1f);

			character.Body.material = _baseMaterial;
        }
        ...
        public SpriteEffect CreateSpriteEffect(Character character, string clipName, int direction = 0, Transform parent = null)
        {
            ...
            instance.GetComponent<SpriteRenderer>().sortingOrder = character.Body.sortingOrder + 1;
